#ifndef KYRIE_INCLUDE_MODEL_MODEL_H_
#define KYRIE_INCLUDE_MODEL_MODEL_H_
...
class Model {
 public:
  ...
  virtual tensor::Tensor& get_buffer(BufferType buffer_idx);

  virtual const tensor::Tensor& get_buffer(BufferType buffer_idx) const;
 ...
 protected:
  virtual base::Status insert_buffer(BufferType buffer_idx, const tensor::Tensor& tensor);
 ...
 protected:
  ...
  std::map<BufferType, tensor::Tensor> buffers_;
...
#endif  // KYRIE_INCLUDE_MODEL_MODEL_H_
